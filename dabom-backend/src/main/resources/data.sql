...
-- <Chapter> --
insert into chapter (id, course_id, sequence, title)
values ('1', '1', '1', '강의 소개'),
       ('2', '1', '2', '객체 지향 설계와 스프링'),
       ('3', '1', '3', '스프링 핵심 원리 이해1 - 예제 만들기'),
       ('4', '1', '4', '스프링 핵심 원리 이해2 - 객체 지향 원리 적용'),
       ('5', '1', '5', '스프링 컨테이너와 스프링 빈'),
       ('6', '1', '6', '싱글톤 컨테이너'),
       ('7', '1', '7', '컴포넌트 스캔'),
       ('8', '1', '8', '의존관계 자동 주입'),
       ('9', '1', '9', '빈 생명주기 콜백'),
...
-- <Feedback> --
insert into feedback (id, created_time, modified_time, comment, thumbs_up, member_id, unit_id)
values
    ('1', '2023-02-08 14:18:05.184415', '2023-02-08 14:18:05.184415', '최고의 강의입니다.', true, '2', '1'),
    ('2', '2023-02-08 14:18:05.184415', '2023-02-08 14:18:05.184415', '이번 강의는 조금 매끄럽지 못하네요', false, '2', '2');