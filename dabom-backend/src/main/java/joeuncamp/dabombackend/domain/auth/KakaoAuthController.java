...
public class KakaoAuthController {
    ...
    public ResponseEntity<TokenForm> login(@RequestBody SocialTokenRequestDto requestDto) {
    ...
    public ResponseEntity<Void> logout(@RequestBody SocialTokenRequestDto requestDto, @RequestHeader(Header.JWT_HEADER) String accessToken) {
    ...
    public ResponseEntity<Void> withdraw(@RequestBody SocialTokenRequestDto requestDto, @RequestHeader(Header.JWT_HEADER) String accessToken) {
