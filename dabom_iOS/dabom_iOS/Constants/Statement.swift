...
extension Const {
    struct Statement {
        ...
        제1조 (목적)
        이 약관은 (주)조은캠프(이하 “회사”라 합니다)이 운영하는 인터넷 관련 서비스(이하 “서비스”라 합니다)의 이용에 관한 조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.
        ...
        자. 기타 법령에 위배되는 행위
        ③ 이용자번호(ID)와 비밀번호의 관리책임은 회원본인에게 있으며 비밀번호가 타인에게 노출된 경우 즉시 변경하여야 합니다. 회원에게 부여된 이용자번호(ID)와 비밀번호의 관리소홀, 부정사용, 서비스를 타인에게 공유, 판매, 대여, 양도하는 행위 및 이를 광고하는 행위 등에 의하여 발생하는 모든 결과에 대한 책임은 회원에게 있습니다.
        ...
        ② 전체 수강기간의 1/2이 지난 경우, 인터넷 강의 특성상 강의를 모두 수강했다고 인정하여 수강 환불 및 취소를 할 수 없습니다.
        ③ 복습기간, 수강연장기간은 정규수강기간에 산정되지 않습니다.
        ④ 수강중인 강좌를 타강좌로 변경하는 경우 직접 변경은 불가능하며 환불처리와 동일한 조건으로 환불처리 후 재신청하셔야 가능합니다.
        ⑤ 유료 서비스의 이용시 부득이한 사정으로 회사가 서비스를 지속할 수 없을 경우, 이에 해당되는 금액을 회원의 계좌로 환불해야 합니다.
        ⑥ 교재 및 강의관련 파일을 다운로드 한 경우 : 판매가의 20% 공제 후 환불
        ⑦ 수강전  7일 이내 : 전액환불
        ⑧ 수강전  7일 이후 : 판매가의 10% 공제 후 환불
            수강전 14일 이후 : 판매가의 30% 공제 후 환불
            수강전 21일 이후 : 판매가의 50% 공제 후 환불
        ⑨ 수강후 7일 이내 : 한 강좌당 2500원 × 이용한 강좌 수
        ⑩ 수강후 7일 이후 : 한 강좌당 2500원 × 이용한 강좌 수 + 판매가의 10% 공제 후 환불
            수강후 14일 이후 : 한 강좌당 2500원 × 이용한 강좌 수 + 판매가의 30% 공제 후 환불
            수강후 21일 이후 : 한 강좌당 2500원 × 이용한 강좌 수 + 판매가의 50% 공제 후 환불
        ⑪ 자격증 취득을 목적으로 하는 강의의 특성상 해당 시험일 이후의 환불 신청은 불가능합니다.
        ⑫ 제9조 (회원의 의무)에 위배되는 경우 환불이 되지 않습니다.
        ⑬ 수강연장은 부가적인 서비스이며 정규수강기간이 아니므로 아이디 공유, 판매, 대여, 양도자의 경우 수강연장서비스에서 제외되며, 수강연장서비스 이용 중 아이디공유 적발시 1차 경고없이 영구 수강정지가 됩니다.
        ⑭ 환급과정 이용시 자격증 시험대비라는 훈련내용 특성상 훈련기간 외에 예습/복습기간이 제공되며,
        1회 수강연장서비스는 제외됩니다. 환급과정 수강 중 환불요청시 일반과정 이용정책과 동일하게 적용됩니다.
                

        제15조 (과오금의 반환)
        ① 회사와 회원간 유료서비스 이용계약이 성립된 후, 이미 그 일부를 이용한 고객은 회사의 귀책사유가 없는 한 계약해지로 요금을 반환 받을수 없습니다.
        ② 회사의 귀책사유로 과오금이 발생한 경우 과오금 전액을 환불 하도록 하며, 신용카드 결제의 경우 카드 결제 취소를 원칙으로 합니다. 단, 기일 경과 등의 사유로 카드 결제 취소가 어려운 경우 현금으로 환불 할 수 있습니다.


        제16조 (교재구매반품/교환/환불)
        ① 구매자는 전자상거래 등에서의 소비자보호에 관한 법률 제17조에 의해 구매한 상품을 배송 받은 후 7일 이내에 환불 또는 교환을 요청하실 수 있습니다.
        단, 구매자의 귀책사유로 말미암아 상품이 멸실 · 훼손된 경우, 구매자의 사용 또는 일부 소비에 의하여 상품의 가치가 현저히 감소한 경우, 시간의 경과에 의하여 재판매가 곤란할 정도로 상품의 가치가 현저히 감소한 경우, 복제가 가능한 상품의 포장을 훼손한 경우 등은 구매자가 환불 또는 교환을 요청할 수 없으며, 구매자의 단순변심에 의한 반품, 교환, 구매자의 잘못으로 다른 교재를 주문했을 경우는 구매자가 왕복 배송비 및 필요한 경비를 부담해야 합니다.
        ② 교재의 파본 등이 구매자의 귀책사유로 인한 경우가 아닌 때에는, "(주)조은캠프"는 구매자의 요구에 따라 환불 또는 교환할 의무가 있습니다. 회사로부터 교환/환불을 승인 받고자 하는 구매자는 객관적인 입증자료를 회사로 송부하여 상품의 원시적인 하자 등 교환/환불사유를 증명하여야 하고, 교환/환불을 위한 반품에 소요되는 배송비 및 필요한 경비는 "(주)조은캠프"가 부담합니다.
        ...
        제20조 (계약해지 및 이용제한)
        ① 회원이 이용계약을 해지하고자 할 때에는 회원본인이 실명, 이용자번호(ID), 주민등록번호 등을 회사에 통보하여 해지신청을 하여야 합니다.
        1. 고객센터: 1566-7909
        2. 전자우편: webmaster@gisa79.com
        3. 환불은 본 약관 제14조 제4항, 제5항의 기간이 지난 경우는 요금반환이 없습니다.
        ...
        16. 서비스에서 얻은 정보를 회사의 사전 승낙없이 회원의 이용 이외의 목적으로 복제하거나 이를 출판 및 방송 등에 사용하거나 제3자에게 제공하는 행위
        ...
        제22조 (손해 배상)
        ① 회사가 1일이상 이용중지 또는 장애가 발생하거나, 장애발생 누적시간이 한달 기준 48시간 초과시 장애시간의 3배의 이용시간을 연장한다.
        ② 천재지변등 불가항력이나 이용자에 대한 서비스 개선 목적으로 한 설비 점검 및 보수시에는 합리적인 시간 내에서 사전 고지후 장애발생 시간에 산입하지 않는다.
        ③ 제3자의 고의 또는 과실로 인하여 중지되거나 장애가 발생한 경우는 사후 고지후 사전 고지를 대체할수 있다.
        ...
        부칙
        1.본 약관은 2010년 4월 10일부터 적용하고, 2009년 5월 16일부터 적용되던 종전의 약관은 본 약관으로 대체합니다
        """
        ...
        접속 로그, 쿠키, 접속IP 정보, MAC Address 정보, IMEI 정보, 결제기록
        ο 개인정보 수집방법 : 홈페이지(회원 가입)
        ...
        ο 보존 항목 : 이름 , 생년월일 , 로그인ID , 비밀번호 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 주민등록번호 , 접속 로그 , 쿠키 , 접속 IP 정보 , 결제기록
        ο 보존 근거 : 다만, 관계법령의 규정에 의하여 보존할 필요성이 있는 경우에는 관계법령에 따라 보존합니다.
        ο 보존 기간 : 서비스를 제공하는 기간 동안에 한하여 제공됩니다.
